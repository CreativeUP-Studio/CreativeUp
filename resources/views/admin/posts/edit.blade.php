        ...
        <div class="admin-compact-header-left">
            ...
            <div class="admin-compact-header-info">
                <h1>
                    ...
                    <span class="admin-compact-header-status {{ $post->status }}">
            ...
            <div class="admin-post-sidebar-card">
                ...
                <div class="admin-post-categories">
                    <label class="admin-category-item">
                        <input type="radio" name="category" value="branding" {{ old('category', $post->category ?? '') === 'branding' ? 'checked' : '' }}>
                    ...
                    <label class="admin-category-item">
                        <input type="radio" name="category" value="diseno" {{ old('category', $post->category ?? '') === 'diseno' ? 'checked' : '' }}>
                        <span class="admin-category-label">
                    ...
                    <label class="admin-category-item">
                        <input type="radio" name="category" value="seo" {{ old('category', $post->category ?? '') === 'seo' ? 'checked' : '' }}>
                        <span class="admin-category-label">
                    ...
                    <label class="admin-category-item">
                        <input type="radio" name="category" value="redes" {{ old('category', $post->category ?? '') === 'redes' ? 'checked' : '' }}>
                        <span class="admin-category-label">
                    ...
                    <label class="admin-category-item">
                        <input type="radio" name="category" value="marketing" {{ old('category', $post->category ?? '') === 'marketing' ? 'checked' : '' }}>
                        <span class="admin-category-label">
...
{{-- Formulario oculto para eliminación (FUERA del formulario principal) --}}
...
async function deletePost(postId) {
    const result = await confirmDelete('este post');
